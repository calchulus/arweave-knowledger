...
var tipTime = moment.utc(tipsArray.tiptime).local().startOf('hour').fromNow();
    ...
    '<div class="ui card"> <div class="content"> <div class="header" style="font-weight: bold; font-size: 1.28571429em; margin-top: -0.21Z425em; margin-bottom: 0.1em; line-height: 1.28571429em; color: rgba(0, 0, 0, 0.85) !important" >' +
      tipsArray.tip + ' </div> <p style="font-size: 0.6em;" class="ui  blue  basic label">' + tipsArray.category + '</p> <p style="font-size: 0.6em;" class="ui  blue  basic label">' + tipTime + '</p><br> <p style="font-size: 0.6em;" class="ui  blue  basic label">' + tipsArray.address +  '</p><p style="font-size: 0.6em;" class="ui  blue  basic label">' + tipsArray.bond  +  '</p> <p>AR</p> <div class="meta"> <p class="description">' + tipsArray.description + '</p></div></div></div></a></li>';  
//    
